...
# export VIDEO=/usr/bin/mplayer

export PATH=$PATH:/home/jenit/bin
export PATH=$PATH:/opt/local/bin
export PATH=$PATH:/home/jenit/pythonProject
export PATH=$PATH:/usr/bin
export PATH=$PATH:/usr/bin/python3

# echo -e "${CYAN}Slackware ${yellow}15! ${CYAN}Сегодня: ${yellow}$(date +%A\ %d-\%m-\%Yг.\ ${CYAN}Актуальное\ время\ ${yellow}%H:%M)\n"
echo -e "${CYAN}Slackware ${yellow}15! ${CYAN}Сегодня: ${yellow}$(date +%A\ %d-\%m-\%Yг.\ ${CYAN}Актуальное\ время\ ${yellow}%H:%M)"

# цвет имени текущего пользователя
PS1='\[\e[1;33m\]\u\[\e[1;35m\]@\[\033[1;32m\]\h \[\e[1;33m\]\w\[\e[m\] \[\e[1;32m\]\$\[\e[m\] \[\e[1;37m\]'
